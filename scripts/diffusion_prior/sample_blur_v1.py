...
def create_argparser():
    ...
    parser.add_argument("--save_dir", default='/nvme/feiben/GDP/generate_images/generated_image_blur_v1', type=str, help='the directory to save the generate images')
    ...
    parser.add_argument("--dataset_path", default='/nvme/feiben/feiben/DDPM_Beat_GAN/evaluations/precomputed/biggan_deep_imagenet64.npz', type=str, help='path to the generated images. Could be an npz file or an image folder')
    ...
    parser.add_argument("--img_guidance_scale", default=300000, type=float, help='guidance scale')
    parser.add_argument("--base_samples", default='/nvme/feiben/DDPM_Beat_GAN/scripts/imagenet_dataloader/blur_resolution_256.npz', type=str, help='the directory or npz file to the guidance imgs. This folder should have the same structure as dataset_path, there should be a one to one mapping between images in them')
